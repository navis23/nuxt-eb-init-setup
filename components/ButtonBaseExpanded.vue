<template>
    <button class="bg-sky-600 text-white p-3 w-full sm:w-40 rounded-md hover:bg-sky-500 hover:text-gray-100 transition ease-in-out duration-300 font-oswald tracking-wide">
        <slot />
    </button>
</template>
