<template>
    <div class="px-4 lg:px-32 py-10">
        <nav class="bg-gray-800 text-white flex flex-col md:flex-row gap-4 justify-between items-center w-full p-4 mb-5 rounded-md">
            <div class="font-bold flex items-center gap-x-2 text-sky-500 uppercase font-oswald">
                ...
                <h1 class="text-2xl md:text-3xl">Table Version 1 for EB UI</h1>
            </div>
                                    ...
                                    <div class="overflow-hidden">
                                        <table class="divide-gray-200 min-w-full table-fixed divide-y">
                                            ...
                                            <tbody class="divide-gray-20 divide-y bg-white">
                                                <tr v-for="product of (products as any[])" :key="product.id" class="hover:bg-gray-50 transition-[height] duration-1000">
