...
export default {
    ...
    global: {
      ...
      input: 'appearance-none bg-white rounded focus:outline-none focus:ring-0 focus:shadow-none',
      ...
      prefixIcon: 'w-10 text-sky-600 flex self-stretch grow-0 shrink-0 rounded-tl rounded-bl bg-white [&>svg]:w-full [&>svg]:max-w-[1em] [&>svg]:max-h-[1em] [&>svg]:m-auto',
    ...
    'family:button': {
      input: '$reset inline-flex items-center bg-sky-600 text-white text-sm font-normal py-3 px-6 rounded focus-visible:outline-2 focus-visible:outline-sky-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin',
      wrapper: 'mb-1',
    ...
    'family:dropdown': {
      ...
      listitem: 'pl-7 relative hover:bg-gray-300 data-[is-active="true"]:bg-gray-300 data-[is-active="true"]:aria-selected:bg-sky-600 aria-selected:bg-sky-600 aria-selected:text-white',
      loaderIcon: 'ml-auto',
    ...
    file: {
      ...
      fileRemove: 'relative z-[2] ml-auto text-[0px] hover:text-red-500 pl-2 peer-data-[has-multiple=true]:text-sm peer-data-[has-multiple=true]:text-sky-500 peer-data-[has-multiple=true]:ml-3 peer-data-[has-multiple=true]:mb-2 formkit-multiple:bottom-[0.15em] formkit-multiple:pl-0 formkit-multiple:ml-0 formkit-multiple:left-[1em] formkit-multiple:formkit-prefix-icon:left-[3.75em]',
    ...
    datepicker: {
      ...
      month: `
        ...
        focus:outline focus:outline-2 focus:outline-sky-500 focus:outline-offset-2 focus:bg-white focus:text-black
      ...
      dayCell: `
        ...
        formkit-disabled:opacity-50 formkit-disabled:cursor-default formkit-disabled:pointer-events-none
      `,
      timeInput: 'w-full border-2 border-gray-300 rounded-md p-2 my-[2em] focus-visible:outline-sky-500',
      ...
      dayButton: 'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-sky-500',
      monthButton: 'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-sky-500',
      yearButton: 'appearance-none cursor-pointer px-3 py-1 border-2 rounded-lg mx-1 hover:border-sky-500',
      ...
      openButton: `
        ...
        focus-visible:outline-none focus-visible:text-white focus-visible:bg-sky-500
      `,
    ...
    repeater: {
      ...
      downControl: 'hover:text-sky-500 disabled:hover:text-inherit disabled:opacity-25',
      fieldset: 'py-4 px-5',
      help: 'mb-2 mt-1.5',
      item: 'flex w-full mb-1 rounded border border-gray-200',
      moveDownIcon: 'block w-3 my-1',
      moveUpIcon: 'block w-3 my-1',
      removeControl: 'hover:text-sky-500 disabled:hover:text-inherit disabled:opacity-25',
      removeIcon: 'block w-5 my-1',
      upControl: 'hover:text-sky-500 disabled:hover:text-inherit disabled:opacity-25'
    },
    slider: {
      outer: 'max-w-md',
      help: 'mt-0 mb-1',
      ...
      fill: 'h-full rounded-full absolute top-0 mx-[-4px] bg-sky-500',
      ...
      handle: 'group w-4 h-4 rounded-full bg-white absolute top-1/2 left-0 z-[2] -translate-x-1/2 -translate-y-1/2 shadow-[inset_0_0_0_1px_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.8)] focus-visible:outline-0 focus-visible:ring-2 ring-sky-500 data-[is-target="true"]:z-[3]',
      tooltip: 'absolute bottom-full left-1/2 -translate-x-1/2 -translate-y-[4px] bg-sky-500 text-white py-1 px-2 text-xs leading-none whitespace-nowrap rounded-sm opacity-0 pointer-events-none transition-opacity after:content-[""] after:absolute after:top-full after:left-1/2 after:-translate-x-1/2 after:-translate-y-[1px] after:border-4 after:border-transparent after:border-t-sky-500 group-hover:opacity-100 group-focus-visible:opacity-100 group-data-[show-tooltip="true"]:opacity-100',
    ...
    taglist: {
      ...
      tagWrapper: 'mr-1 focus:outline-none focus:text-white [&>div]:focus:bg-sky-500 [&>div>button]:focus:text-white',
      tagLabel: 'pl-2 pr-1',
    ...
    toggle: {
      ...
      track: 'p-0.5 min-w-[3em] relative rounded-full transition-all bg-gray-400 peer-checked:bg-sky-500 peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-translate-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:translate-x-0',
      valueLabel: 'font-bold text-sm',
      wrapper: 'flex flex-wrap items-center mb-1'
    },
    transferlist: {
      outer: `
        [&_.dnd-placeholder]:bg-sky-500 [&_.dnd-placeholder]:text-white
      ...
      transferlistListItem: 'pl-8 relative aria-selected:bg-sky-600 aria-selected:data-[is-active=true]:bg-sky-600 aria-selected:text-white aria-selected:data-[is-active=true]:text-white first:-mt-px first:border-t py-2 px-3 flex relative border-b bg-white data-[is-active=true]:text-sky-500 data-[is-active=true]:bg-gray-100 cursor-pointer group-data-[is-max=true]:cursor-not-allowed items-center',
